...
public class Notes
{
    ...
    public static String getStudentClass(int gradeNumber)
    {
         ...
         *      
         *  The expression is evaluated and then the flow of execution jumps to the case that matches.
         */
        String studentClass = "";
    ...
    public static void extraOperatorsExample()
    {
         ...
         *  Perform the specified mathematical operation involving the left operand (variable) and the
         *      right operand and then assigns the resulting value to the same variable.
         */
        int x = 7;
        int y = 7;
        int z = 7;
